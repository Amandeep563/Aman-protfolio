const About = () => {
  const skills = [
    ...
    },
    {
      ...
      logo: (
        <div className="flex space-x-1">
          <svg className="w-4 h-8" viewBox="0 0 24 24" fill="#E34F26">
            <path d="M1.5 0h21l-1.91 21.563L11.977 24l-8.564-2.438L1.5 0zm7.031 9.75l-.232-2.718 10.059.003.23-2.622L5.412 4.41l.698 8.01h9.126l-.326 3.426-2.91.804-2.955-.81-.188-2.11H6.248l.33 4.171L12 19.351l5.379-1.443.744-8.157H8.531z" />
          </svg>
          <svg className="w-4 h-8" viewBox="0 0 24 24" fill="#1572B6">
    ...
    //   logo: (
    //     <svg className="w-8 h-8" viewBox="0 0 24 24" fill="#4A5568">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              ...
              <p className="text-gray-700 text-lg leading-relaxed">
                I specialize in modern frontend tools and aim to build websites
                that are not just beautiful but also functional and accessible.
                I'm currently looking for a Frontend Developer role where I can
                apply my skills and grow as a developer.
              </p>

              <p className="text-gray-700 text-lg leading-relaxed">
                When I'm not coding, I enjoy learning about new tech, improving
                my skills, and working on personal projects that challenge me.
              </p>
            </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  {skills.map((skill, index) => (
                    <div
                      key={index}
                      className="bg-white p-4 border border-gray-200 hover:border-gray-300 transition-colors duration-300 group"
                    >
